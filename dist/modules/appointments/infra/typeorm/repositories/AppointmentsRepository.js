                    ...
                    case 0:
                        ...
                        return [4 /*yield*/, this.ormRepository.find({
                                where: {
                                    ...
                                    date: typeorm_1.Raw(function (dateFieldName) { return "to_char(" + dateFieldName + ",'MM-YYYY') = '" + parsedMonth + "-" + year + "'"; })
                                }
                            })];
                    case 1:
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.ormRepository.find({
                                where: {
                                    provider_id: provider_id,
                                    date: typeorm_1.Raw(function (dateFieldName) { return "to_char(" + dateFieldName + ",'MM-YYYY') = '" + parsedDay + "-" + parsedMonth + "-" + year + "'"; })
                                }
                            })];
                    case 1:
                        appointments = _b.sent();
