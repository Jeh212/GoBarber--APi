                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (date_fns_1.isBefore(appointmentDate, Date.now())) {
                            throw new AppError_1.default("You can't create an appointment on a paste date.");
                        }
                        ...
                        if (date_fns_1.getHours(appointmentDate) < 8 || date_fns_1.getHours(appointmentDate) > 17) {
                            throw new AppError_1.default('You can only create appointments within 8am and 5pm.');
                        }
