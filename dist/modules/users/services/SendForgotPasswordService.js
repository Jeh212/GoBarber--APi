...
var SendForgotPasswordService = /** @class */ (function () {
    function SendForgotPasswordService(userRepository, mailProvider, userTokensRepository) {
        this.userRepository = userRepository;
        this.mailProvider = mailProvider;
        this.userTokensRepository = userTokensRepository;
    }
    SendForgotPasswordService.prototype.execute = function (_a) {
        var email = _a.email;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        user = _b.sent();
                        if (!user) {
                            throw new AppError_1.default('User Do not exist!');
                        }
    ...
    SendForgotPasswordService = __decorate([
    ...
    return SendForgotPasswordService;
}());
