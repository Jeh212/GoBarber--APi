...
var SendForgotPasswordService_1 = __importDefault(require("./SendForgotPasswordService"));
...
describe('SendForgotPasswordService', function () {
    beforeEach(function () {
        ...
        sendForgotPasswordEmail = new SendForgotPasswordService_1.default(fakeUserRepository, fakeMailProvider, fakeUserTokensRepository);
    });
    it('Should be able to recover de password using email account!', function () { return __awaiter(void 0, void 0, void 0, function () {
        var sendMail;
    ...
    it('Should not be able to receiver a non-existing user password', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('Should generate a forgot password token', function () { return __awaiter(void 0, void 0, void 0, function () {
        var generateToken, sendForgotPasswordEmail, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
