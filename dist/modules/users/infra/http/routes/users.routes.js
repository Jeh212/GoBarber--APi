...
var updateUserAvatar = new UserAvatarController_1.default();
...
usersRouter.patch('/avatar', ensureAuthenticated_1.default, upload.single('avatar'), updateUserAvatar.update);
